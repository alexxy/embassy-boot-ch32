 ...
 * and 32 KiB of SRAM that run the USB DFU bootloader: CH32V305FBP6,
 * CH32V305GBU6, CH32V305RBT6.
 *
 * The USB stack makes the bootloader bigger than the UART one, which is paid
 * for by taking 16 KiB away from the active partition. See
 * `flash128k-ram64k-usb.x` for the same layout on the 64 KiB RAM parts.
 *
