 ...
 * and 64 KiB of SRAM that run the CAN-bus update bootloader: CH32V303RCT6,
 * CH32V303VCT6, CH32V307RCT6, CH32V307VCT6, CH32V307WCU6.
 *
 * The CAN transport (driver plus the update protocol codec) does not fit into
 * the 16 KiB bootloader partition the serial map uses, which is paid for by
 * taking 8 KiB away from the active partition.
 *
